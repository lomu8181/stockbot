...
#stock_list_file_path = "C:/Users/Lee Hoyeon/Desktop/101/게만아 파이썬 주식 자동매매봇/stockbot/StockList.json"
try:
...
#stock_dict_file_path = "C:/Users/Lee Hoyeon/Desktop/101/게만아 파이썬 주식 자동매매봇/stockbot/StockDict.json"
try:
    #이 부분이 파일을 읽어서 리스트에 넣어주는 로직입니다. 
